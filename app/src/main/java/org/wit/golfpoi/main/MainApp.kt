    ...
    override fun onCreate() {
        ...
        if (golfPOIData.findUser("davidcorrigan1@gmail.com") == null) {
            ...
            if (testUser != null && testUser2 != null) {
                golfPOIData.createPOI(GolfPOIModel(1000,"Wexford Golf Course", "Beautiful par 72 in the South East of Ireland. The greens on this course are like carpet and the fairways are immalculate.", "Leinster", 72, Uri.EMPTY, 52.25260421972287, -7.338150110840797, 16f, testUser.id))
                golfPOIData.createPOI(GolfPOIModel(1001,"Cork Golf Course", "Beautiful par 71 in the South west of this beautiful country. The greens on this course are like carpet and the fairways are immalculate.", "Munster", 71, Uri.EMPTY, 52.25260421972287, -7.158150110840797, 15f, testUser2.id))
                golfPOIData.createPOI(GolfPOIModel(1002,"Galway Golf Course", "Beautiful par 70 in the west of Ireland. The greens on this course are like carpet and the fairways are immalculate.", "Connaght", 70, Uri.EMPTY, 52.25260421972287, -7.138150110840797, 15f, testUser.id))
                golfPOIData.createPOI(GolfPOIModel(1003,"Donegal Golf Course", "Beautiful par 72 in the North west of this beautiful country. The greens on this course are like carpet and the fairways are immalculate. I would totally recommend this course to anyone wishing to play", "Ulster", 72, Uri.EMPTY, 52.23260421972287, -7.138150110840797, 15f, testUser.id))
                ...
                golfPOIData.createPOI(GolfPOIModel(1006,"Dublin Golf Course", "Beautiful par 72 in the East of Ireland. The greens on this course are like carpet and the fairways are immalculate. I would totally recommend this course to anyone wishing to play", "Leinster", 72, Uri.EMPTY, 52.45260421972287, -7.138150110840797, 15f, testUser2.id))
                golfPOIData.createPOI(GolfPOIModel(1007,"Wicklow Golf Course", "Beautiful par 71 in the East of this beautiful county. The greens on this course are like carpet and the fairways are immalculate. I would totally recommend this course to anyone wishing to play", "Leinster", 71, Uri.EMPTY, 52.75260421972287, -7.138150110840797, 15f, testUser.id))
            }
        }
