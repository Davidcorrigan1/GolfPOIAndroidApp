    ...
    override fun onCreate() {
        ...
        if (golfPOIData.findUser("davidcorrigan1@gmail.com") == null) {
            ...
            if (testUser != null && testUser2 != null) {
                golfPOIData.createPOI(GolfPOIModel(1000,"Wexford Golf Course", "Beautiful par 72 in the South East of Ireland. The greens on this course are like carpet and the fairways are immalculate.", "Leinster", 72, Uri.EMPTY, 52.32580421972287, -6.466550110840797, 16f, testUser.id))
                golfPOIData.createPOI(GolfPOIModel(1001,"Kerry Golf Course", "Beautiful par 71 in the South west of this beautiful country. The greens on this course are like carpet and the fairways are immalculate.", "Munster", 71, Uri.EMPTY, 51.87514821972287, -9.672122510840797, 15f, testUser2.id))
                golfPOIData.createPOI(GolfPOIModel(1002,"Westport Golf Club", "Beautiful par 70 in the west of Ireland. The greens on this course are like carpet and the fairways are immalculate.", "Connaght", 70, Uri.EMPTY, 53.81460421972287, -9.562150110840797, 15f, testUser.id))
                golfPOIData.createPOI(GolfPOIModel(1003,"Royal Portrush Golf Club", "Beautiful par 72 in the North west of this beautiful country. The greens on this course are like carpet and the fairways are immalculate. I would totally recommend this course to anyone wishing to play", "Ulster", 72, Uri.EMPTY, 55.19960421972287, -6.635150110840797, 15f, testUser.id))
