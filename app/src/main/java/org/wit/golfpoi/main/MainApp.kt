...
class MainApp : Application() {
    ...
    override fun onCreate() {
        ...
        i("Golf POI started")
        golfPOIData.createPOI(GolfPOIModel(1000,"Wexford GOlf Course", "Beautiful par 72 in the west of this beautiful county. The greens on this course are like carpet and the fairways are immalculate.", "Munster", 72, Uri.EMPTY, 52.25260421972287, -7.338150110840797, 15f))
