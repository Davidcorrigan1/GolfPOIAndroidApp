...
class MainApp : Application() {
    ...
    override fun onCreate() {
        ...
        i("Golf POI started")
        golfPOIs.createPOI(GolfPOIModel(1000,"Wexford GOlf Course", "Beautiful par 70", "Munster"))
        golfPOIs.createPOI(GolfPOIModel(1001,"Cork GOlf Course", "Beautiful par 71", "Leinster"))
        golfPOIs.createPOI(GolfPOIModel(1002,"Galway GOlf Course", "Beautiful par 72", "Leinster"))
